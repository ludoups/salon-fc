...
window.addEventListener('scroll', () => {
    ...
    function gestionHeaderMobile(){
        ...
        headerLogo.style.display = 'flex';
        headerMobile.style.justifyContent = "space-between";
        headerMobile.style.backgroundColor = "#afa2b9ff";
        menuIcon.style.backgroundColor = "#afa2b900";
        } else {
            headerLogo.style.display = 'none';
            headerMobile.style.justifyContent = "right";
            headerMobile.style.backgroundColor = "#afa2b900";
            menuIcon.style.backgroundColor = "#afa2b9ff";
        }
    }

    function gestionHeaderDesktop(){
        headerMobile.style.backgroundColor = "#afa2b9";
        headerLogo.style.display = 'flex';
        headerMobile.style.justifyContent = "space-between";
    }
